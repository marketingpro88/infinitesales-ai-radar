#!/usr/bin/env python3
"""
InfiniteSales AI Radar Dashboard Generator
--------------------------------
Pulls the viral posts table from Airtable and bakes a static dashboard
into docs/index.html for GitHub Pages.
...
TABLES = [
    {"id": "tblh4P8I4IV965Czd", "label": "InfiniteSales AI Radar"},
]
...
<title>InfiniteSales AI Radar</title>
...
<header>
  <div class="hrow">
    <div class="brand">
      ...
      <h1>InfiniteSales AI Radar<small id="updated"></small></h1>
    </div>
...
<footer>数据来源 Airtable · 每周日自动更新 · 状态更改即时同步全团队 · 视频由 Instagram 官方 embed 播放</footer>
<div id="toast"></div>
